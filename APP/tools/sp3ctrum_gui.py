...
class Application(Frame):
    def __init__(self, toplevel):
        ...
        self.file_name_box = Listbox(self.file_container, relief=RIDGE, borderwidth=3, width=84, height=10, background="#8EF0F7")
        ...
        self.lg1_title = Label(self.logos_title_container, text="UV-Vis", background="#8EF0F7", font="Helvetica 23 bold italic").grid(row=0, column=0)
        self.lg1_title = Label(self.logos_title_container, text="Sp3ctrum P4tronus", background="#8EF0F7", font="Helvetica 23 bold italic").grid(row=1, column=0)
        self.lg2_title = Label(self.logos_title_container, text="Powered by:", background="#8EF0F7", font="Helvetica 16 italic").grid(row=2, column=0)
        self.lg2_title = Label(self.logos_title_container, text="LEEDMOL Group:", background="#8EF0F7", font="Helvetica 20 bold italic").grid(row=3, column=0)
