...
class Opening(object):
    ...
    def welcome(self):
        ...
        print("         |    l   | ")
        print("       _/j  L l\_ | \n")
        print("Welcome to Spectrum UVvis Patronus (version {}), your favorite UV-vis Spectrum simulation APP through oscillator strength calculations.\n" .format(self.version))
        print("This APP was developed by Thiago Lopes and made available by the LEEDMOL group (Laboratório de Estrutura Eletrônica e Dinâmica Molecular) of the Institute of Chemistry at the Universidade de Brasília (UnB).\n")
